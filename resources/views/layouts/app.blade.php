    ...
    <header class="border-b border-gray-800">
        <nav class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
            <div class="flex flex-col lg:flex-row items-center">
                <a href="/">
                    <img src="{{asset('img/laracasts-logo.svg')}}" alt="Laracasts"  class="w-32 flex-none">
                </a>
            ...
            <div class="flex items-center mt-6 lg:mt-0">
                <div class="relative">
                    <input type="text" class="bg-gray-800 pl-8 text-sm rounded-full focus:outline-none focus:shadow-outline px-3 py-1 w-64" placeholder="Search...">
