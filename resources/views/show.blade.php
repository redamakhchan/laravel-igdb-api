...
@section('content')
    <div class="container mx-auto px-4">
                ...
                @if(!is_null($game['trailer']))
                    ...
                    >
                        ...
                        <template x-if="modalOpen">
                            <div
                                    class="z-50 fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto  bg-opacity-70 bg-black"
                            >
                                <div
        ...
        @if(!is_null($game['screenshots']))
            <div
                    x-data="{imageModalOpen : false, image: ''}"
